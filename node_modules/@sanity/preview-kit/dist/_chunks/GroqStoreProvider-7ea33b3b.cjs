...
const GroqStoreProvider = react.memo(function GroqStoreProvider2(props) {
  ...
  const report = react.useMemo(() => {
    if (config.listen) {
      return "Updates are applied in real-time. The cache is set to max ".concat(config.documentLimit || context.DEFAULT_MAX_DOCUMENTS, " documents.");
    }
    return "Updates require a manual refresh. The cache is set to max ".concat(config.documentLimit || context.DEFAULT_MAX_DOCUMENTS, " documents.");
...
//# sourceMappingURL=GroqStoreProvider-7ea33b3b.cjs.map
