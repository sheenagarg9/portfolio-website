...
async function getBuildAction() {
  const mod = await import('./buildAction-6e79193a.js');
  return mod.default;
}
const checkCommand = {
  name: "check",
...
const deployCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployAction-c4e0d01f.js');
...
async function getDevAction() {
  const mod = await import('./devAction-b95dca63.js');
  return mod.default;
}
...
async function getPreviewAction$1() {
  const mod = await import('./previewAction-61e8383d.js');
  return mod.default;
}
...
const listGraphQLAPIsCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./listApisAction-a148926e.js');
    return mod.default(args, context);
  },
  helpText: helpText$4
};
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./deployApiAction-9622065f.js');
    return mod.default(args, context);
  },
  helpText: helpText$3
};
...
//# sourceMappingURL=_internal-005c7774.js.map
