...
async function getBuildAction() {
  const mod = await Promise.resolve().then(function () {
    return require('./buildAction-555595e0.js');
  });
  return mod.default;
}
const checkCommand = {
...
const deployCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./deployAction-16805c38.js');
    });
...
async function getDevAction() {
  const mod = await Promise.resolve().then(function () {
    return require('./devAction-352ae9c3.js');
  });
  return mod.default;
}
...
async function getPreviewAction$1() {
  const mod = await Promise.resolve().then(function () {
    return require('./previewAction-b2db7500.js');
  });
  return mod.default;
}
...
const listGraphQLAPIsCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./listApisAction-09e4981e.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$4
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./deployApiAction-fa7b88e9.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$3
...
//# sourceMappingURL=_internal-f777504c.js.map
